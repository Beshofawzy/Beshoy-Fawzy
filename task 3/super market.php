            ...
            <div class="row">
                ...
                <form action="" method="POST">
                    <div class="col-4 offset-4  mt-5">
                        ...
                        <button type="submit" class="btn btn-warning center" name="submit"> Enter Products</button>
                        ...
                        if (isset($_POST["submit"])) { ?>
                            ...
                            <button type="submit" class="btn btn-warning center " name="invoice" value="">recipt</button>
                        <?php } ?>
                        ...
                        if (isset($_POST["invoice"])) { ?>
                            ...
                            <table class="table mt-3">
                                ...
                                <td class="h4 text-warning">Amount</td>
                                <td class="h4 text-warning"><?= $amount ?></td>
                            </table>
                        <?php }
                        ?>
