...
if($_SERVER['REQUEST_METHOD'] == "POST") {
   ...
   if (empty($_POST['number'])) {
    $errors['number'] = "<div class='text-warning font-weight'>number is required</div>";
}
